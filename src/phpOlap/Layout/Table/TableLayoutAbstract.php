...
abstract class TableLayoutAbstract implements LayoutInterface
{
     ...
     *
     */
	abstract public function renderHeaderCellAxis($row, $col, $axisSet);
     ...
     *
     */
	abstract public function renderBodyCellAxis($row, $col, $axisSet);
     ...
     *
     */
	abstract public function renderBodyCellData($ordinal);
